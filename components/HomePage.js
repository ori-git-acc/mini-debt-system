		...
		>
			<main className="flex flex-col gap-8 items-center sm:items-center bg-gray-900">
				...
				<div className="flex gap-4 items-center flex-row flex-wrap justify-center">
					...
					<button
						className="rounded-full border border-solid bg-gray-800 border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:hover:bg-gray-700 hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-44"
